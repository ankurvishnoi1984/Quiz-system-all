...
export const RealtimeEvent = {
  ...
  QUESTION_SUBMISSIONS_CLOSED: 'question_submissions_closed',
  ALL_QUESTIONS_SUBMISSIONS_CLOSED: 'all_questions_submissions_closed',
  QUESTION_REATTEMPT_OPENED: 'question_reattempt_opened',
